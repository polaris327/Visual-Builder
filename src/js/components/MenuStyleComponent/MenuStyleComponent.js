import './MenuStyleComponent.scss';
...
export default class MenuStyleComponent extends Component {
    ...
    return (
      <div>
        <Tooltip placement={this.state.direction} className='in' id='tooltip-top'>
          ...
          {!this.state.compactView && <Button onClick={this.handleHoverPickerClick.bind(this)} title='Hover Color'><i className="fa fa-cog" style={styles.hoverPickedColor} /></Button>}
          {this.state.displayHoverPicker &&
            <div style={this.state.compactView ? styles.compactPopover : styles.fullPopover}>
              <div style={styles.cover} onClick={this.handleHoverPickerClose.bind(this)} />
              <SketchPicker color={this.state.hoverColor} onChange={this.handleHoverColorChange.bind(this)} />
            </div>
          }
          {!this.state.compactView && <Button onClick={this.toggleIconPicker.bind(this)} title='Choose Icon'><i className='fa fa-thumbs-up' /></Button>}

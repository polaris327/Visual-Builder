import './IconStyleComponent.scss';

import React, { Component, PropTypes } from 'react';
import { Tooltip, Button, Glyphicon, DropdownButton, MenuItem } from 'react-bootstrap';
import { SketchPicker } from 'react-color';
import reactCSS from 'reactcss';
import { ChooseIconComponent } from '../../components';

export default class IconStyleComponent extends Component {
    ...
    return (
      <div>
        <Tooltip placement={this.state.direction} className='in' id='tooltip-top'>
          <Button onClick={this.toggleIconPicker.bind(this)} title='Choose Icon'><i className='fa fa-thumbs-up' /></Button>
